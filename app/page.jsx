      ...
      <div className="container mx-auto px-4 py-8 relative z-10">
        ...
        <div className="text-center py-20">
          ...
          <div className={`flex flex-col sm:flex-row gap-4 justify-center transition-all duration-1000 delay-1100 ${isLoaded ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'}`}>
            <Button size="lg" asChild className="text-lg px-8 py-6 bg-white text-blue-900 hover:bg-white/90 transition-all duration-300 hover:scale-105 hover:shadow-2xl group">
              <Link href="/dashboard">
            ...
            <Button size="lg" variant="outline" asChild className="text-lg px-8 py-6 text-white border-white/30 bg-white/10 hover:bg-white/20 transition-all duration-300 hover:scale-105">
              <Link href="/dashboard">
          ...
          <div className="bg-white/10 backdrop-blur-lg rounded-3xl border border-white/20 p-12 max-w-3xl mx-auto relative overflow-hidden group">
            ...
            <div className="relative z-10">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <Button size="lg" asChild className="text-lg px-8 py-6 bg-white text-blue-900 hover:bg-white/90 transition-all duration-300 hover:scale-105 group">
                  <Link href="/dashboard">
                    <Play className="mr-2 h-5 w-5 group-hover:scale-110 transition-transform" />
                    Launch Dashboard
                    <ArrowRight className="ml-2 h-5 w-5 group-hover:translate-x-1 transition-transform" />
