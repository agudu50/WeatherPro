            ...
            <div>
              ...
              {precipitationData && (
                <div className="flex flex-wrap items-center gap-2 mt-1 text-sm font-medium text-slate-500 dark:text-slate-400">
                  ...
                  <span className="font-mono text-xs bg-slate-100 dark:bg-slate-900 px-1.5 py-0.5 rounded text-slate-655 dark:text-slate-450 border border-slate-200 dark:border-slate-800">
